...
void loop() {
  ...
  stepper1.moveTo(coms.motorPositions[0], .5);
  stepper2.moveTo(coms.motorPositions[1], .5);
  stepper3.moveTo(coms.motorPositions[2], .5);
  stepper4.moveTo(coms.motorPositions[3], .5);
  stepper1.update();
  stepper2.update();
  stepper3.update();
  stepper4.update();
